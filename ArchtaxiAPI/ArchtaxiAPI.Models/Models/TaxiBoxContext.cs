...
namespace ArchtaxiAPI.Models.Models
{
    public partial class TaxiBoxContext : DbContext
    {
        ...
        public virtual DbSet<Airports2> Airports2s { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Airports2>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("Airports2");

                entity.Property(e => e.Airport).HasMaxLength(250);

                entity.Property(e => e.AirportCode).HasMaxLength(20);

                entity.Property(e => e.City).HasMaxLength(100);

                entity.Property(e => e.Country).HasMaxLength(100);

                entity.Property(e => e.CountryAbbrev).HasMaxLength(20);
                ...
                entity.Property(e => e.WorldAreaCode).HasMaxLength(20);
            });
